...
public class VineBlock extends Block implements net.minecraftforge.common.IShearable {
   ...
   public void func_225534_a_(BlockState p_225534_1_, ServerWorld p_225534_2_, BlockPos p_225534_3_, Random p_225534_4_) {
      ...
      } else if (p_225534_2_.rand.nextInt(4) == 0 && p_225534_2_.isAreaLoaded(p_225534_3_, 4)) { // Forge: check area to prevent loading unloaded chunks
         ...
         if (direction.getAxis().isHorizontal() && !p_225534_1_.get(getPropertyFor(direction))) {
            ...
            if (p_225534_3_.getY() > 0) {
               ...
               if (blockstate1.isAir(p_225534_2_, blockpos1) || blockstate1.getBlock() == this) {
                  BlockState blockstate2 = blockstate1.isAir(p_225534_2_, blockpos1) ? this.getDefaultState() : blockstate1;
