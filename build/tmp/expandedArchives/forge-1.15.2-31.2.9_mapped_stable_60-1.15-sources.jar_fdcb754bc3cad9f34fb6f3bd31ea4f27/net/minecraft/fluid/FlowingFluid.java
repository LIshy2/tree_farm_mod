   ...
   public Vec3d getFlow(IBlockReader p_215663_1_, BlockPos p_215663_2_, IFluidState p_215663_3_) {
      ...
      try (BlockPos.PooledMutable blockpos$pooledmutable = BlockPos.PooledMutable.func_185346_s()) {
         for(Direction direction : Direction.Plane.HORIZONTAL) {
            blockpos$pooledmutable.func_189533_g(p_215663_2_).func_189536_c(direction);
            ...
            if (this.isSameOrEmpty(ifluidstate)) {
               ...
               if (f == 0.0F) {
                  if (!p_215663_1_.getBlockState(blockpos$pooledmutable).getMaterial().blocksMovement()) {
                     BlockPos blockpos = blockpos$pooledmutable.func_177977_b();
         ...
         if (p_215663_3_.get(FALLING)) {
            for(Direction direction1 : Direction.Plane.HORIZONTAL) {
               blockpos$pooledmutable.func_189533_g(p_215663_2_).func_189536_c(direction1);
