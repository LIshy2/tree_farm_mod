...
public class FlamingSittingPhase extends SittingPhase {
   ...
   public void serverTick() {
      ...
      if (this.flameTicks >= 200) {
         ...
         Vec3d vec3d = (new Vec3d(this.dragon.dragonPartHead.func_226277_ct_() - this.dragon.func_226277_ct_(), 0.0D, this.dragon.dragonPartHead.func_226281_cx_() - this.dragon.func_226281_cx_())).normalize();
         float f = 5.0F;
         double d0 = this.dragon.dragonPartHead.func_226277_ct_() + vec3d.x * 5.0D / 2.0D;
         double d1 = this.dragon.dragonPartHead.func_226281_cx_() + vec3d.z * 5.0D / 2.0D;
