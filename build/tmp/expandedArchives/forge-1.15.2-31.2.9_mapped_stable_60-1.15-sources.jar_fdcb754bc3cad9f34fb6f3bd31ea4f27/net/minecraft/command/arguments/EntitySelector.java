...
public class EntitySelector {
      ...
      if (!this.includeNonPlayers) {
         ...
         if (this.self) {
            ...
            if (this.isWorldLimited()) {
               this.func_197348_a(list, source.func_197023_e(), vec3d, predicate);
            } else {
               for(ServerWorld serverworld : source.getServer().getWorlds()) {
                  this.func_197348_a(list, serverworld, vec3d, predicate);
               }
            }
   ...
   private void func_197348_a(List<Entity> result, ServerWorld worldIn, Vec3d pos, Predicate<Entity> predicate) {
      if (this.aabb != null) {
