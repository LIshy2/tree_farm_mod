...
public class LlamaModel<T extends AbstractChestedHorseEntity> extends EntityModel<T> {
   ...
   public LlamaModel(float p_i47226_1_) {
      ...
      this.field_228273_a_.func_78784_a(0, 14).func_228301_a_(-4.0F, -16.0F, -6.0F, 8.0F, 18.0F, 6.0F, p_i47226_1_);
      this.field_228273_a_.func_78784_a(17, 0).func_228301_a_(-4.0F, -19.0F, -4.0F, 3.0F, 3.0F, 2.0F, p_i47226_1_);
      this.field_228273_a_.func_78784_a(17, 0).func_228301_a_(1.0F, -19.0F, -4.0F, 3.0F, 3.0F, 2.0F, p_i47226_1_);
