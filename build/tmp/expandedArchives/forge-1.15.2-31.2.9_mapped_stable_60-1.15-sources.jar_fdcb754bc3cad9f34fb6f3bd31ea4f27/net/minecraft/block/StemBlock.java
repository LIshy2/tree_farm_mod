      ...
      if (p_225534_2_.func_226659_b_(p_225534_3_, 0) >= 9) {
         ...
         if (net.minecraftforge.common.ForgeHooks.onCropsGrowPre(p_225534_2_, p_225534_3_, p_225534_1_, p_225534_4_.nextInt((int)(25.0F / f) + 1) == 0)) {
            ...
            if (i < 7) {
               ...
               BlockState soil = p_225534_2_.getBlockState(blockpos.func_177977_b());
               Block block = soil.getBlock();
               if (p_225534_2_.isAirBlock(blockpos) && (soil.canSustainPlant(p_225534_2_, blockpos.func_177977_b(), Direction.UP, this) || block == Blocks.FARMLAND || block == Blocks.DIRT || block == Blocks.COARSE_DIRT || block == Blocks.PODZOL || block == Blocks.GRASS_BLOCK)) {
