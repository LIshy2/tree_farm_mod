...
public class LookAtGoal extends Goal {
   ...
   public void tick() {
      this.entity.getLookController().setLookPosition(this.closestEntity.func_226277_ct_(), this.closestEntity.func_226280_cw_(), this.closestEntity.func_226281_cx_());
      --this.lookTime;
   }
}