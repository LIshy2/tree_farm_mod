...
public class CelebrateRaidVictoryTask extends Task<VillagerEntity> {
   ...
   protected void func_212833_d_(ServerWorld worldIn, VillagerEntity owner, long gameTime) {
      ...
      if (random.nextInt(200) == 0 && MoveToSkylightTask.func_226306_a_(worldIn, owner, new BlockPos(owner))) {
         ...
         FireworkRocketEntity fireworkrocketentity = new FireworkRocketEntity(owner.world, owner.func_226277_ct_(), owner.func_226280_cw_(), owner.func_226281_cx_(), itemstack);
