   ...
   private IronGolemEntity trySpawnGolem() {
      ...
      for(int i = 0; i < 10; ++i) {
         ...
         for(int j = 0; j >= -12; --j) {
            ...
            if ((this.world.getBlockState(blockpos1).isAir() || this.world.getBlockState(blockpos1).getMaterial().isLiquid()) && this.world.getBlockState(blockpos1.func_177977_b()).getMaterial().isOpaque()) {
               d2 += (double)j;
               break;
            }
         }
