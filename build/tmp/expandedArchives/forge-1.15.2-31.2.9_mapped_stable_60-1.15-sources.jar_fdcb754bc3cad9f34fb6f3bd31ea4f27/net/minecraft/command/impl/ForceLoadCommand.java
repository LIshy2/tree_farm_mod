...
public class ForceLoadCommand {
   ...
   private static int doQuery(CommandSource p_212713_0_, ColumnPos p_212713_1_) throws CommandSyntaxException {
      ...
      DimensionType dimensiontype = p_212713_0_.func_197023_e().getDimension().getType();
      boolean flag = p_212713_0_.getServer().func_71218_a(dimensiontype).getForcedChunks().contains(chunkpos.asLong());
      if (flag) {
   ...
   private static int doList(CommandSource p_212721_0_) {
      DimensionType dimensiontype = p_212721_0_.func_197023_e().getDimension().getType();
      LongSet longset = p_212721_0_.getServer().func_71218_a(dimensiontype).getForcedChunks();
      int i = longset.size();
      if (i > 0) {
   ...
   private static int removeAll(CommandSource p_212722_0_) {
      DimensionType dimensiontype = p_212722_0_.func_197023_e().getDimension().getType();
      ServerWorld serverworld = p_212722_0_.getServer().func_71218_a(dimensiontype);
   ...
   private static int doAddOrRemove(CommandSource p_212719_0_, ColumnPos p_212719_1_, ColumnPos p_212719_2_, boolean p_212719_3_) throws CommandSyntaxException {
      ...
      if (i >= -30000000 && j >= -30000000 && k < 30000000 && l < 30000000) {
         ...
         if (i2 > 256L) {
            ...
            DimensionType dimensiontype = p_212719_0_.func_197023_e().getDimension().getType();
            ServerWorld serverworld = p_212719_0_.getServer().func_71218_a(dimensiontype);
