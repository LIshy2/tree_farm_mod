   ...
   public boolean itemInteractionForEntity(ItemStack stack, PlayerEntity playerIn, LivingEntity target, Hand hand) {
      if (target instanceof PigEntity) {
         ...
         if (pigentity.isAlive() && !pigentity.getSaddled() && !pigentity.isChild()) {
            ...
            pigentity.world.playSound(playerIn, pigentity.func_226277_ct_(), pigentity.func_226278_cu_(), pigentity.func_226281_cx_(), SoundEvents.ENTITY_PIG_SADDLE, SoundCategory.NEUTRAL, 0.5F, 1.0F);
            stack.shrink(1);
            return true;
         }
      }
