         ...
         if (p_225534_2_.isAirBlock(blockpos) && blockpos.getY() < p_225534_2_.getDimension().getHeight()) {
            ...
            if (i < 5 && net.minecraftforge.common.ForgeHooks.onCropsGrowPre(p_225534_2_, blockpos, p_225534_1_, true)) {
               ...
               if (block == Blocks.END_STONE) {
                  ...
                  for(int k = 0; k < 4; ++k) {
                     Block block1 = p_225534_2_.getBlockState(p_225534_3_.func_177979_c(j + 1)).getBlock();
               ...
               if (flag && areAllNeighborsEmpty(p_225534_2_, blockpos, (Direction)null) && p_225534_2_.isAirBlock(p_225534_3_.up(2))) {
                  ...
                  for(int i1 = 0; i1 < l; ++i1) {
                     ...
                     if (p_225534_2_.isAirBlock(blockpos1) && p_225534_2_.isAirBlock(blockpos1.func_177977_b()) && areAllNeighborsEmpty(p_225534_2_, blockpos1, direction.getOpposite())) {
