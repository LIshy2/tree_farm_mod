...
public class SwimmerPathNavigator extends PathNavigator {
   ...
   protected void pathFollow() {
      if (this.currentPath != null) {
         ...
         // Forge: fix MC-94054
         if (Math.abs(this.entity.func_226277_ct_() - (vec3d2.x + ((int)(this.entity.getWidth() + 1) / 2D))) < (double)f1 && Math.abs(this.entity.func_226281_cx_() - (vec3d2.z + ((int)(this.entity.getWidth() + 1) / 2D))) < (double)f1 && Math.abs(this.entity.func_226278_cu_() - vec3d2.y) < (double)(f1 * 2.0F)) {
