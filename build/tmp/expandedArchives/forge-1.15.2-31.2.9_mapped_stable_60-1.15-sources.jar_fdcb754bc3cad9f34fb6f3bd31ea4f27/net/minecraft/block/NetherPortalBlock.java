   ...
   public static class Size {
      ...
      protected int getDistanceUntilEdge(BlockPos pos, Direction directionIn) {
         ...
         for(i = 0; i < 22; ++i) {
            ...
            if (!this.func_196900_a(this.world.getBlockState(blockpos)) || !this.world.getBlockState(blockpos.func_177977_b()).isPortalFrame(this.world, blockpos.func_177977_b())) {
               break;
            }
         }
