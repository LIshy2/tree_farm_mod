      ...
      if (this.getHealth() <= 0.0F) {
         ...
         if (this.isAIDisabled()) {
            ...
            if (this.world.isRemote) {
               ...
               if (vec3d != null) {
                  double d8 = vec3d.x - this.func_226277_ct_();
                  double d9 = vec3d.y - this.func_226278_cu_();
                  double d10 = vec3d.z - this.func_226281_cx_();
            ...
            for(int j = 0; j < this.dragonParts.length; ++j) {
               avec3d[j] = new Vec3d(this.dragonParts[j].func_226277_ct_(), this.dragonParts[j].func_226278_cu_(), this.dragonParts[j].func_226281_cx_());
            }
         ...
         for(int l1 = j; l1 <= i1; ++l1) {
            for(int i2 = k; i2 <= j1; ++i2) {
               ...
               if (!blockstate.isAir(this.world, blockpos) && blockstate.getMaterial() != Material.FIRE) {
                  if (net.minecraftforge.common.ForgeHooks.canEntityDestroy(this.world, blockpos, this) && !BlockTags.DRAGON_IMMUNE.func_199685_a_(block)) {
