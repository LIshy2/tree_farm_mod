...
public class WalkNodeProcessor extends NodeProcessor {
   ...
   public PathPoint getStart() {
      ...
      if (this.getCanSwim() && this.entity.isInWater()) {
         ...
         BlockPos blockpos;
         for(blockpos = new BlockPos(this.entity); (this.blockaccess.getBlockState(blockpos).isAir() || this.blockaccess.getBlockState(blockpos).allowsMovement(this.blockaccess, blockpos, PathType.LAND)) && blockpos.getY() > 0; blockpos = blockpos.func_177977_b()) {
            ;
         }
