...
public class WitchModel<T extends Entity> extends VillagerModel<T> {
   ...
   private final ModelRenderer mole = (new ModelRenderer(this)).func_78787_b(64, 128);

   public WitchModel(float scale) {
      super(scale, 64, 128);
      this.mole.setRotationPoint(0.0F, -2.0F, 0.0F);
      this.mole.func_78784_a(0, 0).func_228301_a_(0.0F, 3.0F, -6.75F, 1.0F, 1.0F, 1.0F, -0.25F);
      this.villagerNose.func_78792_a(this.mole);
      this.villagerHead = (new ModelRenderer(this)).func_78787_b(64, 128);
      this.villagerHead.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.villagerHead.func_78784_a(0, 0).func_228301_a_(-4.0F, -10.0F, -4.0F, 8.0F, 10.0F, 8.0F, scale);
      this.field_217151_b = (new ModelRenderer(this)).func_78787_b(64, 128);
      this.field_217151_b.setRotationPoint(-5.0F, -10.03125F, -5.0F);
      this.field_217151_b.func_78784_a(0, 64).func_228300_a_(0.0F, 0.0F, 0.0F, 10.0F, 2.0F, 10.0F);
      ...
      modelrenderer.func_78784_a(0, 76).func_228300_a_(0.0F, 0.0F, 0.0F, 7.0F, 4.0F, 7.0F);
      modelrenderer.rotateAngleX = -0.05235988F;
      modelrenderer.rotateAngleZ = 0.02617994F;
      this.field_217151_b.func_78792_a(modelrenderer);
      ModelRenderer modelrenderer1 = (new ModelRenderer(this)).func_78787_b(64, 128);
      modelrenderer1.setRotationPoint(1.75F, -4.0F, 2.0F);
      modelrenderer1.func_78784_a(0, 87).func_228300_a_(0.0F, 0.0F, 0.0F, 4.0F, 4.0F, 4.0F);
      ...
      modelrenderer2.func_78784_a(0, 95).func_228301_a_(0.0F, 0.0F, 0.0F, 1.0F, 2.0F, 1.0F, 0.25F);
