...
public class EndermanEntity extends MonsterEntity {
   ...
   private boolean shouldAttackPlayer(PlayerEntity player) {
      ...
      if (itemstack.getItem() == Blocks.CARVED_PUMPKIN.asItem()) {
         ...
         Vec3d vec3d1 = new Vec3d(this.func_226277_ct_() - player.func_226277_ct_(), this.func_226280_cw_() - player.func_226280_cw_(), this.func_226281_cx_() - player.func_226281_cx_());
