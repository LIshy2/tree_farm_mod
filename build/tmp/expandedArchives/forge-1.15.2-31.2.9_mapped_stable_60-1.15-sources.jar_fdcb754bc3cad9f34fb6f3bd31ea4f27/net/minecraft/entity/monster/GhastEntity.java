      ...
      public void tick() {
         ...
         if (livingentity.getDistanceSq(this.parentEntity) < 4096.0D && this.parentEntity.canEntityBeSeen(livingentity)) {
            ...
            if (this.attackTimer == 20) {
               ...
               double d2 = livingentity.func_226277_ct_() - (this.parentEntity.func_226277_ct_() + vec3d.x * 4.0D);
               double d3 = livingentity.func_226283_e_(0.5D) - (0.5D + this.parentEntity.func_226283_e_(0.5D));
               double d4 = livingentity.func_226281_cx_() - (this.parentEntity.func_226281_cx_() + vec3d.z * 4.0D);
               ...
               fireballentity.setPosition(this.parentEntity.func_226277_ct_() + vec3d.x * 4.0D, this.parentEntity.func_226283_e_(0.5D) + 0.5D, fireballentity.func_226281_cx_() + vec3d.z * 4.0D);
