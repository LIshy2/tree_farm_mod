...
public class HorseModel<T extends AbstractHorseEntity> extends AgeableModel<T> {
   ...
   public HorseModel(float p_i51065_1_) {
      ...
      this.field_217128_b.func_78792_a(modelrenderer);
      this.field_217128_b.func_78792_a(modelrenderer1);
      this.field_217128_b.func_78792_a(modelrenderer2);
      ...
      this.field_217127_a.func_78792_a(modelrenderer3);
      ...
      this.field_217128_b.func_78792_a(modelrenderer4);
      ...
      this.field_217128_b.func_78792_a(modelrenderer5);
      ...
      this.field_217128_b.func_78792_a(modelrenderer6);
      ...
      this.field_217128_b.func_78792_a(modelrenderer9);
   ...
   protected void func_199047_a(ModelRenderer p_199047_1_) {
      ...
      p_199047_1_.func_78792_a(modelrenderer);
      p_199047_1_.func_78792_a(modelrenderer1);
   }
