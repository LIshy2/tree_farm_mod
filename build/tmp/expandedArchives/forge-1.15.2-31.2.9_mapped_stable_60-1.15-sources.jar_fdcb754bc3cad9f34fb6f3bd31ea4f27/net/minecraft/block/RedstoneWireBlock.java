...
public class RedstoneWireBlock extends Block {
   ...
   public void updateDiagonalNeighbors(BlockState state, IWorld worldIn, BlockPos pos, int flags) {
      try (BlockPos.PooledMutable blockpos$pooledmutable = BlockPos.PooledMutable.func_185346_s()) {
         for(Direction direction : Direction.Plane.HORIZONTAL) {
            ...
            if (redstoneside != RedstoneSide.NONE && worldIn.getBlockState(blockpos$pooledmutable.func_189533_g(pos).func_189536_c(direction)).getBlock() != this) {
               ...
               blockpos$pooledmutable.func_189533_g(pos).func_189536_c(direction).func_189536_c(Direction.UP);
   ...
   private RedstoneSide getSide(IBlockReader worldIn, BlockPos pos, Direction face) {
      ...
      return !canConnectTo(blockstate, worldIn, blockpos, face) && (blockstate.isNormalCube(worldIn, blockpos) || !canConnectTo(worldIn.getBlockState(blockpos.func_177977_b()), worldIn, blockpos.func_177977_b(), null)) ? RedstoneSide.NONE : RedstoneSide.SIDE;
   }
      ...
      if (j < 15) {
         for(Direction direction : Direction.Plane.HORIZONTAL) {
            ...
            if (blockstate1.isNormalCube(p_212568_1_, blockpos) && !p_212568_1_.getBlockState(blockpos1).isNormalCube(p_212568_1_, blockpos1)) {
               ...
               k = this.maxSignal(k, p_212568_1_.getBlockState(blockpos.func_177977_b()));
            }
         }
      }
   ...
   private boolean isPowerSourceAt(IBlockReader worldIn, BlockPos pos, Direction side) {
      ...
      if (!flag1 && flag && canConnectTo(worldIn.getBlockState(blockpos.up()), worldIn, blockpos.up(), null)) {
         ...
         return !flag && canConnectTo(worldIn.getBlockState(blockpos.func_177977_b()), worldIn, blockpos.func_177977_b(), null);
      }
   }
