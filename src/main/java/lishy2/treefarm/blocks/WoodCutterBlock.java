...
public class WoodCutterBlock extends Block implements IGrowable {
    ...
    public void func_225535_a_(ServerWorld p_225535_1_, Random p_225535_2_, BlockPos p_225535_3_, BlockState p_225535_4_) {
        ...
        for (int i = 0; i < 128; ++i) {
            ...
            while (true) {
                ...
                if (p_225535_1_.getBlockState(blockpos1.func_177977_b()).getBlock() != this || p_225535_1_.getBlockState(blockpos1).func_224756_o(p_225535_1_, blockpos1)) {
                    break;
                }
