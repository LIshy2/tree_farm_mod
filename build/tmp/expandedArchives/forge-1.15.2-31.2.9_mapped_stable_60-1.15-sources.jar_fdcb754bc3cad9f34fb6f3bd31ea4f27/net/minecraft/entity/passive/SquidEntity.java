...
public class SquidEntity extends WaterMobEntity {
   ...
   private void squirtInk() {
      ...
      Vec3d vec3d = this.func_207400_b(new Vec3d(0.0D, -1.0D, 0.0D)).add(this.func_226277_ct_(), this.func_226278_cu_(), this.func_226281_cx_());
   ...
   class FleeGoal extends Goal {
      ...
      public void tick() {
         ...
         if (livingentity != null) {
            Vec3d vec3d = new Vec3d(SquidEntity.this.func_226277_ct_() - livingentity.func_226277_ct_(), SquidEntity.this.func_226278_cu_() - livingentity.func_226278_cu_(), SquidEntity.this.func_226281_cx_() - livingentity.func_226281_cx_());
            BlockState blockstate = SquidEntity.this.world.getBlockState(new BlockPos(SquidEntity.this.func_226277_ct_() + vec3d.x, SquidEntity.this.func_226278_cu_() + vec3d.y, SquidEntity.this.func_226281_cx_() + vec3d.z));
            IFluidState ifluidstate = SquidEntity.this.world.getFluidState(new BlockPos(SquidEntity.this.func_226277_ct_() + vec3d.x, SquidEntity.this.func_226278_cu_() + vec3d.y, SquidEntity.this.func_226281_cx_() + vec3d.z));
