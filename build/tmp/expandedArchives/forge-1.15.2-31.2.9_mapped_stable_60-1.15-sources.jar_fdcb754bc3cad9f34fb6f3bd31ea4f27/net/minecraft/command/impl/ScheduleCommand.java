...
public class ScheduleCommand {
   ...
   private static final SuggestionProvider<CommandSource> field_229812_c_ = (p_229814_0_, p_229814_1_) -> {
      return ISuggestionProvider.suggest(p_229814_0_.getSource().func_197023_e().getWorldInfo().getScheduledEvents().func_227574_a_(), p_229814_1_);
   };
   ...
   private static int func_229816_a_(CommandSource p_229816_0_, Either<FunctionObject, Tag<FunctionObject>> p_229816_1_, int p_229816_2_, boolean p_229816_3_) throws CommandSyntaxException {
      if (p_229816_2_ == 0) {
         ...
         long i = p_229816_0_.func_197023_e().getGameTime() + (long)p_229816_2_;
         TimerCallbackManager<MinecraftServer> timercallbackmanager = p_229816_0_.func_197023_e().getWorldInfo().getScheduledEvents();
   ...
   private static int func_229817_a_(CommandSource p_229817_0_, String p_229817_1_) throws CommandSyntaxException {
      int i = p_229817_0_.func_197023_e().getWorldInfo().getScheduledEvents().func_227575_a_(p_229817_1_);
      if (i == 0) {
