...
public class VillagerModel<T extends Entity> extends SegmentedModel<T> implements IHasHead, IHeadToggle {
   ...
   public VillagerModel(float p_i51059_1_, int p_i51059_2_, int p_i51059_3_) {
      float f = 0.5F;
      this.villagerHead = (new ModelRenderer(this)).func_78787_b(p_i51059_2_, p_i51059_3_);
      this.villagerHead.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.villagerHead.func_78784_a(0, 0).func_228301_a_(-4.0F, -10.0F, -4.0F, 8.0F, 10.0F, 8.0F, p_i51059_1_);
      this.field_217151_b = (new ModelRenderer(this)).func_78787_b(p_i51059_2_, p_i51059_3_);
      this.field_217151_b.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.field_217151_b.func_78784_a(32, 0).func_228301_a_(-4.0F, -10.0F, -4.0F, 8.0F, 10.0F, 8.0F, p_i51059_1_ + 0.5F);
      this.villagerHead.func_78792_a(this.field_217151_b);
      this.field_217152_f = (new ModelRenderer(this)).func_78787_b(p_i51059_2_, p_i51059_3_);
      this.field_217152_f.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.field_217152_f.func_78784_a(30, 47).func_228301_a_(-8.0F, -8.0F, -6.0F, 16.0F, 16.0F, 1.0F, p_i51059_1_);
      this.field_217152_f.rotateAngleX = (-(float)Math.PI / 2F);
      this.field_217151_b.func_78792_a(this.field_217152_f);
      this.villagerNose = (new ModelRenderer(this)).func_78787_b(p_i51059_2_, p_i51059_3_);
      this.villagerNose.setRotationPoint(0.0F, -2.0F, 0.0F);
      this.villagerNose.func_78784_a(24, 0).func_228301_a_(-1.0F, -1.0F, -6.0F, 2.0F, 4.0F, 2.0F, p_i51059_1_);
      this.villagerHead.func_78792_a(this.villagerNose);
      this.villagerBody = (new ModelRenderer(this)).func_78787_b(p_i51059_2_, p_i51059_3_);
      this.villagerBody.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.villagerBody.func_78784_a(16, 20).func_228301_a_(-4.0F, 0.0F, -3.0F, 8.0F, 12.0F, 6.0F, p_i51059_1_);
      this.field_217153_h = (new ModelRenderer(this)).func_78787_b(p_i51059_2_, p_i51059_3_);
      this.field_217153_h.setRotationPoint(0.0F, 0.0F, 0.0F);
      this.field_217153_h.func_78784_a(0, 38).func_228301_a_(-4.0F, 0.0F, -3.0F, 8.0F, 18.0F, 6.0F, p_i51059_1_ + 0.5F);
      this.villagerBody.func_78792_a(this.field_217153_h);
      this.villagerArms = (new ModelRenderer(this)).func_78787_b(p_i51059_2_, p_i51059_3_);
      this.villagerArms.setRotationPoint(0.0F, 2.0F, 0.0F);
      this.villagerArms.func_78784_a(44, 22).func_228301_a_(-8.0F, -2.0F, -2.0F, 4.0F, 8.0F, 4.0F, p_i51059_1_);
      this.villagerArms.func_78784_a(44, 22).func_228303_a_(4.0F, -2.0F, -2.0F, 4.0F, 8.0F, 4.0F, p_i51059_1_, true);
      this.villagerArms.func_78784_a(40, 38).func_228301_a_(-4.0F, 2.0F, -2.0F, 8.0F, 4.0F, 4.0F, p_i51059_1_);
      this.rightVillagerLeg = (new ModelRenderer(this, 0, 22)).func_78787_b(p_i51059_2_, p_i51059_3_);
      ...
      this.leftVillagerLeg = (new ModelRenderer(this, 0, 22)).func_78787_b(p_i51059_2_, p_i51059_3_);
