...
public class ShowVillagerFlowerGoal extends Goal {
   ...
   public boolean shouldExecute() {
      if (!this.ironGolem.world.isDaytime()) {
         ...
         this.villager = this.ironGolem.world.getClosestEntityWithinAABB(VillagerEntity.class, field_220738_a, this.ironGolem, this.ironGolem.func_226277_ct_(), this.ironGolem.func_226278_cu_(), this.ironGolem.func_226281_cx_(), this.ironGolem.getBoundingBox().grow(6.0D, 2.0D, 6.0D));
