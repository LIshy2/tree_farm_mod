...
public abstract class InteractDoorGoal extends Goal {
   ...
   public void tick() {
      float f = (float)((double)((float)this.doorPosition.getX() + 0.5F) - this.entity.func_226277_ct_());
      float f1 = (float)((double)((float)this.doorPosition.getZ() + 0.5F) - this.entity.func_226281_cx_());
