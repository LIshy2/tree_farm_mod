...
public class LookRandomlyGoal extends Goal {
   ...
   public void tick() {
      --this.idleTime;
      this.field_75258_a.getLookController().setLookPosition(this.field_75258_a.func_226277_ct_() + this.lookX, this.field_75258_a.func_226280_cw_(), this.field_75258_a.func_226281_cx_() + this.lookZ);
   }
}