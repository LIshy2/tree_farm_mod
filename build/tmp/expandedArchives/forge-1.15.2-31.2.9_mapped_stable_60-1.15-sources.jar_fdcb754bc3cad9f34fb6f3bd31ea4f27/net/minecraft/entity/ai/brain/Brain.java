...
public class Brain<E extends LivingEntity> implements IDynamicSerializable {
   ...
   public void func_218210_a(ServerWorld worldIn, E entityIn) {
      this.func_218229_c(worldIn, entityIn);
   ...
   public void func_218227_b(ServerWorld worldIn, E owner) {
      ...
      this.getRunningTasks().forEach((p_218206_4_) -> {
         p_218206_4_.func_220380_e(worldIn, owner, i);
      });
   }
   ...
   private void func_218229_c(ServerWorld worldIn, E entityIn) {
      this.sensors.values().forEach((p_218201_2_) -> {
         p_218201_2_.func_220973_b(worldIn, entityIn);
      });
   }
   ...
   private void func_218218_d(ServerWorld worldIn, E entityIn) {
      ...
      this.field_218232_c.values().stream().flatMap((p_218219_0_) -> {
         ...
         p_218192_4_.func_220378_b(worldIn, entityIn, i);
      });
   }
   ...
   private void func_218222_e(ServerWorld worldIn, E entityIn) {
      ...
      this.getRunningTasks().forEach((p_218220_4_) -> {
         p_218220_4_.func_220377_c(worldIn, entityIn, i);
      });
   }
