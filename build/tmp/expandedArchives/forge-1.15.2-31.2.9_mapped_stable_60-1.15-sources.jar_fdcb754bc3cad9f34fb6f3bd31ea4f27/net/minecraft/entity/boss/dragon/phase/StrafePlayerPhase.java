   ...
   public void serverTick() {
      if (this.attackTarget == null) {
         ...
         if (this.currentPath != null && this.currentPath.isFinished()) {
            ...
            this.targetLocation = new Vec3d(d0, this.attackTarget.func_226278_cu_() + d5, d1);
         }
         ...
         if (this.attackTarget.getDistanceSq(this.dragon) < 4096.0D) {
            if (this.dragon.canEntityBeSeen(this.attackTarget)) {
               ++this.fireballCharge;
               Vec3d vec3d1 = (new Vec3d(this.attackTarget.func_226277_ct_() - this.dragon.func_226277_ct_(), 0.0D, this.attackTarget.func_226281_cx_() - this.dragon.func_226281_cx_())).normalize();
               ...
               if (this.fireballCharge >= 5 && f >= 0.0F && f < 10.0F) {
                  ...
                  double d6 = this.dragon.dragonPartHead.func_226277_ct_() - vec3d2.x * 1.0D;
                  double d7 = this.dragon.dragonPartHead.func_226283_e_(0.5D) + 0.5D;
                  double d8 = this.dragon.dragonPartHead.func_226281_cx_() - vec3d2.z * 1.0D;
