...
public class MerchantContainer extends Container {
   ...
   private void playMerchantYesSound() {
      if (!this.merchant.getWorld().isRemote) {
         ...
         this.merchant.getWorld().playSound(entity.func_226277_ct_(), entity.func_226278_cu_(), entity.func_226281_cx_(), this.merchant.getYesSound(), SoundCategory.NEUTRAL, 1.0F, 1.0F, false);
      }
