...
public class TurtleEntity extends AnimalEntity {
   ...
   public static boolean func_223322_c(EntityType<TurtleEntity> p_223322_0_, IWorld p_223322_1_, SpawnReason reason, BlockPos p_223322_3_, Random p_223322_4_) {
      return p_223322_3_.getY() < p_223322_1_.getSeaLevel() + 4 && p_223322_1_.getBlockState(p_223322_3_.func_177977_b()).getBlock() == Blocks.SAND && p_223322_1_.func_226659_b_(p_223322_3_, 0) > 8;
   }
   ...
   public float getBlockPathWeight(BlockPos pos, IWorldReader worldIn) {
      if (!this.isGoingHome() && worldIn.getFluidState(pos).isTagged(FluidTags.WATER)) {
         ...
         return worldIn.getBlockState(pos.func_177977_b()).getBlock() == Blocks.SAND ? 10.0F : worldIn.getBrightness(pos) - 0.5F;
      }
   }
   ...
   public void livingTick() {
      ...
      if (this.isAlive() && this.isDigging() && this.isDigging >= 1 && this.isDigging % 5 == 0) {
         ...
         if (this.world.getBlockState(blockpos.func_177977_b()).getBlock() == Blocks.SAND) {
