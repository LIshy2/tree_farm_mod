...
public class ShulkerBulletEntity extends Entity {
   ...
   public void tick() {
      ...
      this.setPosition(this.func_226277_ct_() + vec3d1.x, this.func_226278_cu_() + vec3d1.y, this.func_226281_cx_() + vec3d1.z);
      ProjectileHelper.rotateTowardsMovement(this, 0.5F);
      if (this.world.isRemote) {
         this.world.addParticle(ParticleTypes.END_ROD, this.func_226277_ct_() - vec3d1.x, this.func_226278_cu_() - vec3d1.y + 0.15D, this.func_226281_cx_() - vec3d1.z, 0.0D, 0.0D, 0.0D);
