...
public abstract class AbstractSmallTreeFeature<T extends TreeFeatureConfig> extends AbstractTreeFeature<T> {
   ...
   public Optional<BlockPos> func_227212_a_(IWorldGenerationReader p_227212_1_, int p_227212_2_, int p_227212_3_, int p_227212_4_, BlockPos p_227212_5_, TreeFeatureConfig p_227212_6_) {
      ...
      if (blockpos.getY() >= 1 && blockpos.getY() + p_227212_2_ + 1 <= p_227212_1_.getMaxHeight()) {
            ...
            for(int k = -j1; k <= j1; ++k) {
               ...
               while(l <= j1) {
                  if (i1 + blockpos.getY() >= 0 && i1 + blockpos.getY() < p_227212_1_.getMaxHeight()) {
                     blockpos$mutable.func_181079_c(k + blockpos.getX(), i1 + blockpos.getY(), l + blockpos.getZ());
         ...
         return isSoilOrFarm(p_227212_1_, blockpos.func_177977_b(), p_227212_6_.getSapling()) && blockpos.getY() < p_227212_1_.getMaxHeight() - p_227212_2_ - 1 ? Optional.of(blockpos) : Optional.empty();
      } else {
         return Optional.empty();
      }
   }
