...
public class FoxModel<T extends FoxEntity> extends AgeableModel<T> {
   ...
   public FoxModel() {
      ...
      this.field_217115_a.func_78792_a(this.field_217116_b);
      this.field_217115_a.func_78792_a(this.field_217117_f);
      this.field_217115_a.func_78792_a(this.field_217118_g);
      ...
      this.field_217119_h.func_78792_a(this.field_217124_m);
   }
   ...
   public void func_225597_a_(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      if (!p_225597_1_.isSleeping() && !p_225597_1_.isStuck() && !p_225597_1_.isCrouching()) {
