      ...
      public void tick() {
         ...
         if (blockpos != null && WanderingTraderEntity.this.navigator.noPath()) {
            if (this.isWithinDistance(blockpos, 10.0D)) {
               Vec3d vec3d = (new Vec3d((double)blockpos.getX() - this.traderEntity.func_226277_ct_(), (double)blockpos.getY() - this.traderEntity.func_226278_cu_(), (double)blockpos.getZ() - this.traderEntity.func_226281_cx_())).normalize();
               Vec3d vec3d1 = vec3d.scale(10.0D).add(this.traderEntity.func_226277_ct_(), this.traderEntity.func_226278_cu_(), this.traderEntity.func_226281_cx_());
