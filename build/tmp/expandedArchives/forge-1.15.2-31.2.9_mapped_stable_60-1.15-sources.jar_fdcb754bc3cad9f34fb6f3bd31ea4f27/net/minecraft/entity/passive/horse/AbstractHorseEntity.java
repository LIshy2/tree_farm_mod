...
public abstract class AbstractHorseEntity extends AnimalEntity implements IInventoryChangedListener, IJumpingMount {
   ...
   public void livingTick() {
      ...
      if (!this.world.isRemote && this.isAlive()) {
         ...
         if (this.canEatGrass()) {
            if (!this.isEatingHaystack() && !this.isBeingRidden() && this.rand.nextInt(300) == 0 && this.world.getBlockState((new BlockPos(this)).func_177977_b()).getBlock() == Blocks.GRASS_BLOCK) {
