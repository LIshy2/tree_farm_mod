...
public class DolphinModel<T extends Entity> extends SegmentedModel<T> {
   ...
   public DolphinModel() {
      ...
      this.field_205082_b.func_78792_a(modelrenderer);
      ...
      this.field_205082_b.func_78792_a(modelrenderer1);
      ...
      this.field_205082_b.func_78792_a(modelrenderer2);
      ...
      this.field_205082_b.func_78792_a(modelrenderer3);
   }
   ...
   public void func_225597_a_(T p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
      ...
      if (Entity.horizontalMag(p_225597_1_.getMotion()) > 1.0E-7D) {
