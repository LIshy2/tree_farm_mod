...
public class MinecartCommandBlockEntity extends AbstractMinecartEntity {
   ...
   public class MinecartCommandLogic extends CommandBlockLogic {
      ...
      public CommandSource getCommandSource() {
         return new CommandSource(this, MinecartCommandBlockEntity.this.getPositionVec(), MinecartCommandBlockEntity.this.getPitchYaw(), this.func_195043_d(), 2, this.getName().getString(), MinecartCommandBlockEntity.this.getDisplayName(), this.func_195043_d().getServer(), MinecartCommandBlockEntity.this);
      }
   }
}