      ...
      if (this.isAlive()) {
         if (this.world.isRemote) {
            ...
            if (!this.isInWater()) {
               ...
               this.clientSideTouchedGround = vec3d.y < 0.0D && this.world.isTopSolid((new BlockPos(this)).func_177977_b(), this);
   ...
   static class MoveHelperController extends MovementController {
      ...
      public void tick() {
         if (this.action == MovementController.Action.MOVE_TO && !this.entityGuardian.getNavigator().noPath()) {
            Vec3d vec3d = new Vec3d(this.posX - this.entityGuardian.func_226277_ct_(), this.posY - this.entityGuardian.func_226278_cu_(), this.posZ - this.entityGuardian.func_226281_cx_());
