...
public class PhantomEntity extends FlyingEntity implements IMob {
   ...
   class OrbitPointGoal extends PhantomEntity.MoveGoal {
      ...
      public void tick() {
         ...
         if (PhantomEntity.this.orbitOffset.y < PhantomEntity.this.func_226278_cu_() && !PhantomEntity.this.world.isAirBlock((new BlockPos(PhantomEntity.this)).func_177979_c(1))) {
   ...
   class SweepAttackGoal extends PhantomEntity.MoveGoal {
      ...
      public void tick() {
         LivingEntity livingentity = PhantomEntity.this.getAttackTarget();
         PhantomEntity.this.orbitOffset = new Vec3d(livingentity.func_226277_ct_(), livingentity.func_226283_e_(0.5D), livingentity.func_226281_cx_());
