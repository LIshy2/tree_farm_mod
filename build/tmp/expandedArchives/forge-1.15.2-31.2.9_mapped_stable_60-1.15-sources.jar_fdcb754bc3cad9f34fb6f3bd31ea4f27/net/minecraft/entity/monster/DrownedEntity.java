   ...
   static class SwimUpGoal extends Goal {
      ...
      public void tick() {
         if (this.field_204736_a.func_226278_cu_() < (double)(this.targetY - 1) && (this.field_204736_a.getNavigator().noPath() || this.field_204736_a.isCloseToPathTarget())) {
            Vec3d vec3d = RandomPositionGenerator.findRandomTargetBlockTowards(this.field_204736_a, 4, 8, new Vec3d(this.field_204736_a.func_226277_ct_(), (double)(this.targetY - 1), this.field_204736_a.func_226281_cx_()));
            if (vec3d == null) {
