...
public enum B3DLoader implements ISelectiveResourceReloadListener
{
    ...
    private static final class ModelWrapper implements IUnbakedModel
    {
        ...
        @Override
        public Collection<Material> func_225614_a_(Function<ResourceLocation, IUnbakedModel> modelGetter, Set<com.mojang.datafixers.util.Pair<String, String>> missingTextureErrors)
        {
