...
public class WitherModel<T extends WitherEntity> extends SegmentedModel<T> {
   ...
   public WitherModel(float p_i46302_1_) {
      ...
      this.upperBodyParts[1] = (new ModelRenderer(this)).func_78787_b(this.textureWidth, this.textureHeight);
      this.upperBodyParts[1].setRotationPoint(-2.0F, 6.9F, -0.5F);
      this.upperBodyParts[1].func_78784_a(0, 22).func_228301_a_(0.0F, 0.0F, 0.0F, 3.0F, 10.0F, 3.0F, p_i46302_1_);
      this.upperBodyParts[1].func_78784_a(24, 22).func_228301_a_(-4.0F, 1.5F, 0.5F, 11.0F, 2.0F, 2.0F, p_i46302_1_);
      this.upperBodyParts[1].func_78784_a(24, 22).func_228301_a_(-4.0F, 4.0F, 0.5F, 11.0F, 2.0F, 2.0F, p_i46302_1_);
      this.upperBodyParts[1].func_78784_a(24, 22).func_228301_a_(-4.0F, 6.5F, 0.5F, 11.0F, 2.0F, 2.0F, p_i46302_1_);
