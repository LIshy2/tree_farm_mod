      ...
      if (p_196991_0_.func_196966_y().field_196995_b.remove(p_196991_1_)) {
         ...
         for(BlockPos blockpos : BlockPos.getAllInBoxMutable(k, 0, i1, l, world.getHeight() - 1, j1)) {
            ...
            for(Direction direction : adirection) {
               blockpos$mutable.func_189533_g(blockpos).func_189536_c(direction);
         ...
         for(int i = 0; i < 16; ++i) {
            ...
            if (chunksection != null && aint != null && aint.length > 0) {
               ...
               for(int j : aint) {
                  ...
                  int l = j >> 8 & 15;
                  int i1 = j >> 4 & 15;
                  blockpos$pooledmutable.func_181079_c(chunkpos.getXStart() + k, (i << 4) + l, chunkpos.getZStart() + i1);
                  BlockState blockstate = palettedcontainer.get(j);
                  BlockState blockstate1 = blockstate;

                  for(Direction direction : adirection) {
                     blockpos$pooledmutable1.func_189533_g(blockpos$pooledmutable).func_189536_c(direction);
