   ...
   public void func_225551_a_(WorldGenRegion p_225551_1_, IChunk p_225551_2_) {
      ...
      for(int i1 = 0; i1 < 16; ++i1) {
         for(int j1 = 0; j1 < 16; ++j1) {
            ...
            p_225551_1_.func_226691_t_(blockpos$mutable.func_181079_c(k + i1, i2, l + j1)).buildSurface(sharedseedrandom, p_225551_2_, k1, l1, i2, d1, this.getSettings().getDefaultBlock(), this.getSettings().getDefaultFluid(), this.getSeaLevel(), this.world.getSeed());
         }
      }
         ...
         if (l > 0) {
            for(int i1 = l; i1 >= l - 4; --i1) {
               if (i1 >= l - rand.nextInt(5)) {
                  chunkIn.setBlockState(blockpos$mutable.func_181079_c(blockpos.getX(), i1, blockpos.getZ()), Blocks.BEDROCK.getDefaultState(), false);
               }
            }
         }
         ...
         if (k < 256) {
            for(int j1 = k + 4; j1 >= k; --j1) {
               if (j1 <= k + rand.nextInt(5)) {
                  chunkIn.setBlockState(blockpos$mutable.func_181079_c(blockpos.getX(), j1, blockpos.getZ()), Blocks.BEDROCK.getDefaultState(), false);
               }
            }
         }
      }
