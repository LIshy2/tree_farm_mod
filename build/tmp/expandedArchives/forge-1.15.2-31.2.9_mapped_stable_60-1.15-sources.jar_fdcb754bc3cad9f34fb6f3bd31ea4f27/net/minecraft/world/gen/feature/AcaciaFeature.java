...
public class AcaciaFeature extends AbstractSmallTreeFeature<TreeFeatureConfig> {
   ...
   public boolean func_225557_a_(IWorldGenerationReader p_225557_1_, Random p_225557_2_, BlockPos p_225557_3_, Set<BlockPos> p_225557_4_, Set<BlockPos> p_225557_5_, MutableBoundingBox p_225557_6_, TreeFeatureConfig p_225557_7_) {
      ...
      if (!optional.isPresent()) {
         ...
         this.setDirtAt(p_225557_1_, blockpos.func_177977_b(), blockpos);
         ...
         for(int i2 = 0; i2 < i; ++i2) {
            ...
            if (this.func_227216_a_(p_225557_1_, p_225557_2_, blockpos$mutable.func_181079_c(j1, j2, k1), p_225557_4_, p_225557_6_, p_225557_7_)) {
               l1 = j2;
            }
         }
         ...
         if (direction1 != direction) {
            ...
            for(int l2 = j3; l2 < i && k2 > 0; --k2) {
               if (l2 >= 1) {
                  ...
                  if (this.func_227216_a_(p_225557_1_, p_225557_2_, blockpos$mutable.func_181079_c(j1, i3, k1), p_225557_4_, p_225557_6_, p_225557_7_)) {
                     l1 = i3;
                  }
               }
