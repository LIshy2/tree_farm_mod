   ...
   private void addRaiderParticles(World p_222826_1_) {
      if (p_222826_1_.isRemote) {
         ...
         this.entitiesAtRing.stream().filter(this::isNearbyRaider).forEach((p_222831_4_) -> {
            float f = 1.0F;
            float f1 = MathHelper.sqrt((p_222831_4_.func_226277_ct_() - (double)blockpos.getX()) * (p_222831_4_.func_226277_ct_() - (double)blockpos.getX()) + (p_222831_4_.func_226281_cx_() - (double)blockpos.getZ()) * (p_222831_4_.func_226281_cx_() - (double)blockpos.getZ()));
            double d0 = (double)((float)blockpos.getX() + 0.5F) + (double)(1.0F / f1) * (p_222831_4_.func_226277_ct_() - (double)blockpos.getX());
            double d1 = (double)((float)blockpos.getZ() + 0.5F) + (double)(1.0F / f1) * (p_222831_4_.func_226281_cx_() - (double)blockpos.getZ());
